    ...
    <div>
      ...
      <div className="hero-section">
        <div className="container">
          ...
          <p className="lead text-white-50">Descubra as melhores receitas de todo o mundo.</p>
        </div>
      </div>
      ...
      <div className="container" style={{ marginTop: '-40px' }}>
        ...
        <div className="card p-4 mb-5 shadow-lg border-0 bg-dark">
              ...
              <div className="col-md-8">
                ...
                <div className="d-flex justify-content-center gap-4 mb-3 text-white">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="type1">Por <b>Nome</b></label>
                  </div>
                  <div className="form-check">
                    <input className="form-check-input" type="radio" checked={searchType === 'ingredient'} onChange={() => setSearchType('ingredient')} id="type2"/>
                    <label className="form-check-label" htmlFor="type2">Por <b>Ingrediente</b></label>
                  </div>
                </div>
                ...
                <input 
                  ...
                  placeholder={searchType === 'name' ? "Pesquisar (ex: Margarita)..." : "Ingrediente (ex: Vodka)..."}
                  value={searchTerm}
            ...
            <div className="d-flex justify-content-center gap-2 mt-4 flex-wrap">
              ...
              <button className="btn btn-outline-success rounded-pill" onClick={() => onCategory('Ordinary_Drink')}>🍹 Comuns</button>
              <button className="btn btn-outline-info rounded-pill" onClick={() => onCategory('Soft_Drink')}>🥤 Sem Álcool</button>
        ...
        {/* LOADING / ERROR */}
        {loading && <div className="text-center py-5 text-white"><h3>A misturar ingredientes... ⏳</h3></div>}
        {error && <div className="alert alert-danger">{error}</div>}
        {!loading && drinks.length === 0 && searchTerm !== '' && (
           <div className="text-center text-muted py-5"><h3>Nada encontrado. 😕</h3></div>
        )}
